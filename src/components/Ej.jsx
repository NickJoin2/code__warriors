...
import sun from '../assets/dark theme/Sun.svg'
import moon from '../assets/dark theme/Moon.svg'
import vector1 from '../assets/footer/Vector-1.svg'
import vector3 from '../assets/footer/Vector-3.svg'
...
const Ej = () => {
  return (
    ...
    <div class="container">
      <nav class="nav-row">
        <div class="nav__logo">
            <span>Code</span><a class="nav__logo-link" href="./frontend.html"> Warriors</a>


        </div>

        <ul class="nav-menu">
            <li class="nav-item"><a class="nav-link nav__link-active" href="./frontend-project.html">Project</a></li>
            <li class="nav-item"><a class="nav-link" href="./team.html">Team</a></li>
            <li class="nav-item"><a class="nav-link" href="./other_projects.html">Other projects</a></li>
  

            <button className="dark__mode-btn dark__mode-btn-active" id="dark__mode--btn">
              <img className="dark__mode-btn__icon" src={sun}/>
              <img className="dark__mode-btn__icon" src={moon}/>
            </button>
  ...
  <footer class="footer">
    <div class="container">
      <ul class="footer__item">
        <li class="footer__list"><a href="https://vk.com/dogy_bread" target='blank'><img src={vector1}/></a></li>
        <li class="footer__list"><a href="https://github.com/Mogenn" target='blank'><img src={vector3}/></a></li>
      </ul>
